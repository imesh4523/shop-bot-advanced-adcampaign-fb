import { s as useAuth, d as useToast, r as reactExports, u as useQuery, f as useMutation, j as jsxRuntimeExports, L as LoaderCircle, B as Button, t as Shield, v as Mail, M as Megaphone, i as apiRequest, q as queryClient } from "./index-kMYS5d3O.js";
import { C as Card, a as CardHeader, b as CardTitle, d as CardDescription, c as CardContent } from "./card-DpYabRbO.js";
import { I as Input } from "./input-dmvOz8m7.js";
import { T as Textarea } from "./textarea-TXqe3UIi.js";
import { L as Label } from "./label-CvYqJhi8.js";
import { B as Bot } from "./bot-CF4jrVW7.js";
import { S as Sparkles } from "./sparkles-C9pA17Zz.js";
import { S as Save } from "./save-BcEeVb2W.js";
...
function SettingsPage() {
  ...
  const [vertexKey, setVertexKey] = reactExports.useState("");
  ...
  const [defaultTheme, setDefaultTheme] = reactExports.useState("dark");
  const [whatsappLink, setWhatsappLink] = reactExports.useState("");
  ...
  const [isPasskeyRegistering, setIsPasskeyRegistering] = reactExports.useState(false);
  ...
  const registerDevicePasskey = async () => {
    ...
    try {
      ...
      const credential = await navigator.credentials.create({
        publicKey: {
          ...
          rp: {
            ...
            // Matches domain (e.g. localhost or cloudaccount.store)
          },
          user: {
            id: userIdBuffer,
            name: user.email,
          ...
          pubKeyCredParams: [
            ...
            // ES256 (standard EC WebAuthn)
            { type: "public-key", alg: -257 }
            // RS256
          ],
          authenticatorSelection: {
            authenticatorAttachment: "platform",
            // Prompts device native authentication (Touch ID / Face ID / Windows Hello)
      ...
      const publicKeyDerHex = Array.from(new Uint8Array(publicKeyBuffer)).map((b) => b.toString(16).padStart(2, "0")).join("");
  ...
  const [stripeEnabled, setStripeEnabled] = reactExports.useState(true);
  ...
  const { data: vertexSetting } = useQuery({
  ...
  const { data: stripeEnabledSetting, isLoading: isStripeEnabledLoading } = useQuery({
  ...
  reactExports.useEffect(() => {
    if (vertexSetting?.value !== void 0) setVertexKey(vertexSetting.value);
  }, [vertexSetting]);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    if (whatsappLinkSetting?.value !== void 0) setWhatsappLink(whatsappLinkSetting.value || "");
  }, [whatsappLinkSetting]);
  reactExports.useEffect(() => {
    if (loadingTextSetting?.value !== void 0) setLoadingText(loadingTextSetting.value);
  }, [loadingTextSetting]);
  reactExports.useEffect(() => {
    if (defaultThemeSetting?.value !== void 0) setDefaultTheme(defaultThemeSetting.value || "dark");
  }, [defaultThemeSetting]);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    if (stripeEnabledSetting?.value !== void 0) setStripeEnabled(stripeEnabledSetting.value !== "false");
  }, [stripeEnabledSetting]);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-10 animate-in", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass-card border-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "vertexKey", className: "text-sm font-bold text-white/70 uppercase tracking-widest flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-4 h-4 text-purple-400" }),
            "Google Cloud Vertex AI (Service Account JSON)"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-white/40", children: "Paste your Google Cloud IAM Service Account Credentials JSON here to connect Vertex AI (Gemini model)." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                className: "h-12 self-end px-6 rounded-xl bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 font-bold",
                children: vertexMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-5 h-5 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { className: "w-5 h-5" })
              }
            )
          ] })
        ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "gemini", children: "Prefer Gemini AI Studio first" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "vertex", children: "Prefer Google Cloud Vertex AI first" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "openai", children: "Prefer OpenAI/DigitalOcean first" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass-card border-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-bold text-white/70 uppercase tracking-widest", children: "LKR Rate (1 USDT = ? LKR)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                type: "number",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-white/30", children: "Binance P2P rate — LKR per 1 USDT" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass-card border-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-r from-purple-500/20 to-blue-500/20 p-6 border-b border-white/10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-white/40", children: "Set up biometric/device passkey login for fast and secure access on the PWA app." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-6 space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 bg-white/5 border border-white/10 rounded-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-bold text-white", children: "Device Passkey Credentials" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/40", children: user?.passkeyCredential ? "✅ Passkey is configured on your account." : "❌ No passkey registered yet." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: isPasskeyRegistering ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : "Register Device Passkey"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 bg-white/5 border border-white/10 rounded-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-bold text-white", children: "Force Passkey Login for PWA Admin" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/40", children: "Restrict login to passkeys only when logging in as Admin" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: pwaPasskeyOnlyMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : forcePasskeyOnly ? "Enabled" : "Disabled"
            }
          )
        ] })
      ] }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass-card border-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 pt-4 border-t border-white/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-bold text-white/70 uppercase tracking-widest", children: "WhatsApp Contact Link" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 pt-4 border-t border-white/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-bold text-white/70 uppercase tracking-widest", children: "Default Interface Theme (First Visit)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "dark", className: "bg-purple-950 text-white", children: "Dark Theme (Black)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "light", className: "bg-purple-950 text-white", children: "Light Theme (White)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "system", className: "bg-purple-950 text-white", children: "System Preference" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass-card border-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-6 pt-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pt-4 border-t border-white/5 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-bold text-white/70 uppercase tracking-widest block", children: "Stripe Card Gateway Status" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/40 mt-1", children: "Temporarily lock or unlock Stripe card deposits for all USD users." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: stripeEnabled ? "🔓 Unlocked" : "🔒 Locked"
            }
          )
        ] })
      ] })
