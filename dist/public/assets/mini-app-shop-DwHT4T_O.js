import { c as createLucideIcon, R as React, ai as useTheme, j as jsxRuntimeExports, B as Button, H as cn, d as useToast, u as useQuery, r as reactExports, ac as lookup, q as queryClient, e as useMutation, o as User, X, L as LoaderCircle, aj as ChevronRight, v as Send, P as Package, ae as Database, t as ShieldCheck } from "./index-KKsXvly3.js";
...
import { m as motion, A as AnimatePresence } from "./proxy-CoATEr9B.js";
import { W as Wallet } from "./wallet-Bi8GtlsT.js";
import { H as History } from "./history-z-VS5_mh.js";
import { C as CreditCard } from "./credit-card-CsXOuesr.js";
import { Z as Zap } from "./zap-S5mwAjXl.js";
import { C as CircleCheck } from "./circle-check-B64oslTk.js";
import { M as MessageCircle } from "./message-circle-wtm__s59.js";
import { C as Copy } from "./copy-D62PuaYX.js";
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 overflow-x-auto pb-2 px-1 scrollbar-hide no-scrollbar", children: [
          ...
          { id: "chatgpt", label: "ChatGPT", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://svgl.app/library/chatgpt.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) },
          { id: "claude", label: "Claude", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://svgl.app/library/claude.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) },
          { id: "gemini", label: "Gemini", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://svgl.app/library/gemini.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) },
          { id: "cursor", label: "Cursor", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://svgl.app/library/cursor.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) },
          { id: "capcut", label: "CapCut", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://svgl.app/library/capcut.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) }
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-0.5", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl font-black text-neutral-900 dark:text-white tracking-tighter", children: formatPrice(user?.balance || 0, "USD", displayCurrency) })
                  ] })
                ]
              }
            ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-black tracking-tighter text-neutral-900 dark:text-white leading-none italic", children: formatPrice(user?.balance || 0, "USD", displayCurrency) })
            ]
          }
        ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isDepositModalOpen, onOpenChange: (open) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            ...
            !activeDeposit && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center gap-2 mt-4", children: ["USD", "LKR", "INR", "EUR"].map((curr) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => {
                ...
                className: `text-[9px] font-black px-3.5 py-1.5 rounded-full transition-all duration-300 ${displayCurrency === curr ? "bg-purple-600 text-white shadow-md shadow-purple-900/30 scale-105" : "bg-neutral-100 dark:bg-white/5 text-neutral-400 hover:text-neutral-900 dark:hover:text-white border border-neutral-200 dark:border-white/5"}`,
                children: curr
              },
              curr
            )) })
