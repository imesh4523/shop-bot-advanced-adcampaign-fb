import { c as createLucideIcon, R as React, ai as useTheme, j as jsxRuntimeExports, B as Button, H as cn, d as useToast, u as useQuery, r as reactExports, ac as lookup, q as queryClient, e as useMutation, o as User, X, L as LoaderCircle, aj as ChevronRight, v as Send, P as Package, ae as Database, t as ShieldCheck } from "./index-WJuXJIDE.js";
...
import { m as motion, A as AnimatePresence } from "./proxy-6jq8tL_u.js";
import { W as Wallet } from "./wallet-2NS-Xo_S.js";
import { H as History } from "./history-CHZ2udsD.js";
import { C as CreditCard } from "./credit-card-Bg2LhhrW.js";
import { Z as Zap } from "./zap-cVM0w7C8.js";
import { C as CircleCheck } from "./circle-check-5Fby6B88.js";
import { M as MessageCircle } from "./message-circle-BAlmqSfo.js";
import { C as Copy } from "./copy-BKKL2MQh.js";
...
const UserAvatar = ({ fallback: Fallback, className }) => {
...
function MiniAppShop() {
  ...
  const [depositMethod, setDepositMethod] = reactExports.useState("stripe");
  ...
  const handleCreateDeposit = async () => {
    try {
      ...
      if (amt < minDepositLimit2) {
        toast({ title: "Minimum Deposit Required", description: `Minimum deposit amount is $${minDepositLimit2.toFixed(2)}.`, variant: "destructive" });
        return;
      }
  ...
  const renderStore = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-3 mt-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-4xl font-black tracking-tighter leading-none", children: [
                        "$",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 overflow-x-auto pb-2 px-1 scrollbar-hide no-scrollbar", children: [
          { id: "all", label: "All", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "w-4 h-4" }) },
          { id: "aws", label: "AWS", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaAws, { className: "w-4 h-4" }) },
          { id: "digitalocean", label: "DO", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiDigitalocean, { className: "w-4 h-4" }) },
          { id: "azure", label: "Azure", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(VscAzure, { className: "w-4 h-4" }) },
          { id: "google", label: "GCP", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiGooglecloud, { className: "w-4 h-4" }) },
          { id: "vultr", label: "Vultr", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiVultr, { className: "w-4 h-4" }) },
          { id: "hetzner", label: "Hetzner", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiHetzner, { className: "w-4 h-4" }) },
          { id: "oracle", label: "Oracle", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Database, { className: "w-4 h-4" }) },
          { id: "chatgpt", label: "ChatGPT", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://upload.wikimedia.org/wikipedia/commons/0/04/ChatGPT_logo.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) },
          { id: "claude", label: "Claude", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://upload.wikimedia.org/wikipedia/commons/d/d4/Claude_AI_symbol.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) },
          { id: "gemini", label: "Gemini", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://upload.wikimedia.org/wikipedia/commons/1/10/Google_Gemini_icon_2025.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) },
          { id: "cursor", label: "Cursor", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://www.cursor.com/assets/images/logo.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) },
          { id: "capcut", label: "CapCut", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://cdn.jsdelivr.net/npm/@thesvg/icons/icons/capcut.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) }
            ...
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-black text-xl text-neutral-900 dark:text-card-foreground tracking-tighter", children: [
                    "$",
        ...
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right relative z-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-lg font-black text-neutral-900 dark:text-white tracking-tighter", children: [
                "+$",
  ...
  const renderProfile = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 animate-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white dark:bg-card rounded-[3rem] p-10 border border-purple-50 dark:border-white/5 relative overflow-hidden shadow-xl shadow-purple-500/[0.02]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col items-center text-center space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-24 h-24 rounded-[30%] bg-neutral-900 flex items-center justify-center text-white shadow-2xl rotate-12 group-hover:rotate-0 transition-transform duration-500 overflow-hidden ring-4 ring-white dark:ring-neutral-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserAvatar, { fallback: User, className: "w-full h-full -rotate-12 group-hover:rotate-0 transition-transform duration-500" }) }),
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-0.5", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xl font-black text-neutral-900 dark:text-white tracking-tighter", children: [
                      "$",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-amber-50 p-6 rounded-[2rem] border border-amber-100/50 flex items-start gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-2xl bg-white flex items-center justify-center text-amber-500 shrink-0 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-5 h-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-sm font-black text-amber-900 tracking-tight uppercase", children: "Support Security" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] font-bold text-amber-700/70 leading-relaxed uppercase", children: [
            "Your credentials are encrypted end-to-end. Contact ",
            supportUsername,
            " for bulk inquiries."
          ] })
        ] })
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-black tracking-tighter text-neutral-900 dark:text-white leading-none italic", children: isGuest ? "WEB" : user?.firstName?.toUpperCase() || "ACCESS_DENIED" })
            ] })
          ]
        }
      ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-lg font-black tracking-tighter text-neutral-900 dark:text-white leading-none italic", children: [
                "$",
                ((user?.balance || 0) / 100).toFixed(2)
              ] })
            ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!selectedProduct, onOpenChange: (open) => !open && setSelectedProduct(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "rounded-[2.5rem] border-0 bg-white/95 backdrop-blur-xl p-8 shadow-2xl max-w-[90vw] mx-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-6 space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-50/50 p-5 rounded-3xl border border-purple-100 flex justify-between items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-2xl font-black text-purple-900 tracking-tighter", children: [
            "$",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!selectedOffer, onOpenChange: (open) => !open && setSelectedOffer(null), children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "rounded-[3rem] border-0 bg-gradient-to-br from-neutral-900 to-neutral-800 p-0 shadow-2xl max-w-[90vw] mx-auto overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 space-y-6 relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 relative z-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 p-4 rounded-3xl border border-white/5 flex flex-col items-center gap-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xl font-black text-amber-400", children: [
            "$",
            selectedOffer ? (selectedOffer.price / 100).toFixed(2) : "0.00"
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-24 right-4 z-50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isChatOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-4 space-y-4 scrollbar-hide min-h-[300px]", children: [
              chatMode === "ai" ? chatHistory.map((msg, i) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex flex-col w-full ${msg.role === "user" ? "items-end" : "items-start"} animate-in slide-in-from-bottom-2 duration-300`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-[85%] p-3 rounded-2xl text-[11px] leading-relaxed ${msg.role === "user" ? "bg-primary text-white rounded-tr-none shadow-lg" : "bg-white/5 text-white/90 border border-white/10 rounded-tl-none"}`, children: [
                  ...
                  showContactBtn && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 pt-2 border-t border-white/10 flex justify-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(FaTelegram, { className: "w-3 h-3 text-white" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Contact Us" })
                      ]
                    }
                  ) })
                ] }) }, i);
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex flex-col w-full ${!isAdmin ? "items-end" : "items-start"} animate-in slide-in-from-bottom-2 duration-300`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-[85%] p-3 rounded-2xl text-[11px] leading-relaxed ${!isAdmin ? "bg-primary text-white rounded-tr-none shadow-lg" : "bg-gradient-to-br from-purple-600 to-indigo-700 text-white rounded-tl-none border border-white/5 shadow-md"}`, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1 break-all", children: msg.message }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-white/5 border-t border-white/10 flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "text",
        ...
        !activeDeposit ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4 space-y-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: [
              ...
              "button",
              {
                ...
                className: `flex items-center gap-3 p-4 rounded-2xl border text-xs font-black uppercase tracking-wider transition-all ${depositMethod === m.id ? "bg-purple-600 text-white border-purple-600" : "bg-white dark:bg-card text-neutral-500 dark:text-neutral-400 border-purple-50/50 dark:border-white/5 hover:border-purple-200 dark:hover:border-purple-500"}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "pointer-events-none flex items-center gap-3", children: [
                  m.icon,
                  m.name
                ] })
              },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-50/50 dark:bg-white/5 p-5 rounded-3xl border border-purple-100 dark:border-white/10 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-xs", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-black text-neutral-900 dark:text-white", children: [
                "$",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.button,
        {
          ...
          className: `w-14 h-14 rounded-full flex items-center justify-center shadow-2xl transition-all duration-500 ${isChatOpen ? "bg-white text-black rotate-90" : "bg-primary text-white shadow-primary/30"}`,
          children: isChatOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-6 h-6" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-7 h-7" })
        }
      )
    ] })
  ] });
