import { c as createLucideIcon, u as useQuery, a as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, b as clsx, R as React, d as useToast, e as useQueryClient, f as useMutation, j as jsxRuntimeExports, S as ShoppingCart, P as Package, U as Users, B as Button } from "./index-Bn4ygb4t.js";
import { a as api } from "./routes-DLr0d2Nv.js";
import { u as useOrders } from "./use-orders-D4_akA9Z.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-RrwrEOgj.js";
import { S as Skeleton } from "./skeleton-qFKevHVA.js";
import { f as format$1 } from "./format-Fqx7OmaC.js";
import { T as TrendingUp } from "./trending-up-BP5ZxPM2.js";
import { D as DollarSign } from "./dollar-sign-v_qvfiMv.js";
import { E as Eye } from "./eye-CRwmgBCa.js";
import { C as CreditCard } from "./credit-card-XxU938-J.js";
import { L as Lock } from "./lock-uDEQgdYT.js";
import "./index-DwfS90rP.js";
import "./schema-BNl0CAyG.js";
...
function Dashboard() {
  ...
  const { data: stripeEnabledSetting, isLoading: stripeLoading } = useQuery({
  ...
  const stripeToggleMutation = useMutation({
    ...
    onSuccess: (_, enabled) => {
      ...
      toast({
        ...
        description: enabled ? "Card payments are now enabled for all users." : "Card payments have been temporarily disabled."
      });
    },
    onError: () => {
  ...
  const chartData = orders ? Array.from({ length: 7 }, (_, i) => {
    ...
    date2.setDate(date2.getDate() - (6 - i));
    const dayName = format$1(date2, "EEE");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-10 animate-in", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatsCard,
        {
          ...
          value: trafficStats?.dailyPageViews?.toString() ?? "0",
          icon: Eye,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "glass-card border-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center justify-between p-6 transition-all duration-500 ${stripeEnabled ? "bg-gradient-to-r from-violet-500/15 to-blue-500/10" : "bg-gradient-to-r from-red-500/15 to-orange-500/10"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `p-3 rounded-2xl transition-all duration-300 ${stripeEnabled ? "bg-violet-500/20" : "bg-red-500/20"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CreditCard, { className: `w-6 h-6 transition-colors ${stripeEnabled ? "text-violet-400" : "text-red-400"}` }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-lg font-black tracking-tight text-white flex items-center gap-2", children: [
            "Stripe Card Gateway",
            stripeLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-16 bg-white/10 rounded-full" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-bold px-2 py-0.5 rounded-full ${stripeEnabled ? "bg-green-500/20 text-green-400" : "bg-red-500/20 text-red-400"}`, children: stripeEnabled ? "ACTIVE" : "LOCKED" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/40 mt-0.5", children: stripeEnabled ? "Credit/debit card deposits are currently enabled for all users." : "Card deposits are disabled. Users cannot pay via Stripe." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          className: `flex items-center gap-2 h-12 px-6 rounded-2xl font-black text-sm transition-all duration-300 shadow-lg ${stripeEnabled ? "bg-red-500 hover:bg-red-600 text-white shadow-red-500/30" : "bg-gradient-to-r from-violet-500 to-blue-600 hover:opacity-90 text-white shadow-violet-500/30"}`,
          children: stripeToggleMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-spin w-4 h-4 border-2 border-white/50 border-t-white rounded-full" }) : stripeEnabled ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 md:grid-cols-2 lg:grid-cols-7", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "col-span-3 glass-card border-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: ordersLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        ] }, i)) }) : recentOrders.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: recentOrders.map((order) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: order.createdAt ? format$1(new Date(order.createdAt), "MMM d") : "" })
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass-card p-2 border-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-xl font-bold flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "w-5 h-5 text-primary" }),
        "Traffic Activity (Last 7 Days)"
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pl-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[300px] w-full", children: trafficLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-[250px] w-full bg-white/5" }) }) : trafficStats?.chartData ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data: trafficStats.chartData, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "colorViews", x1: "0", y1: "0", x2: "0", y2: "1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: "hsl(var(--primary))", stopOpacity: 0.3 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "95%", stopColor: "hsl(var(--primary))", stopOpacity: 0 })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "colorVisitors", x1: "0", y1: "0", x2: "0", y2: "1", children: [
      ...
      ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center text-muted-foreground", children: "No traffic data recorded yet." }) }) })
    ] })
  ] });
}
function StatsCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glass-card border-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-xl bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-4 w-4 text-primary" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-black tracking-tight", children: value }),
