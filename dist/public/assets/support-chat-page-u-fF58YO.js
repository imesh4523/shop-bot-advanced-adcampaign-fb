import { d as useToast, K as useQueryClient, r as reactExports, u as useQuery, e as useMutation, ac as lookup, j as jsxRuntimeExports, f as MessageSquare, L as LoaderCircle, B as Button, ah as Settings, v as Send, h as apiRequest } from "./index-WJuXJIDE.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent, d as CardDescription } from "./card-DrB_UqIi.js";
...
import { B as Bot } from "./bot-CMeY5oDT.js";
...
function SupportChatPage() {
  ...
  const sendReplyMutation = useMutation({
    mutationFn: async ({ telegramId, message }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 animate-in fade-in duration-700", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8 min-h-[650px]", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "lg:col-span-2 glass-card border-0 flex flex-col h-[650px] overflow-hidden", children: selectedChatId && activeChat ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "p-5 border-b border-white/5 shrink-0 flex flex-row items-center justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex gap-3 max-w-[70%] items-end ${isAdmin ? "flex-row-reverse" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex flex-col space-y-1`, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `px-4 py-3 rounded-2xl shadow-sm text-sm font-medium leading-relaxed break-all ${isAdmin ? "bg-[#18112e] text-white rounded-br-none border border-white/5" : "bg-gradient-to-br from-purple-600 to-indigo-700 text-white rounded-bl-none"}`, children: msg.message }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 bg-[#0f0a1a] border-t border-white/5 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "form",
          {
            onSubmit: (e) => {
              e.preventDefault();
