import { c as createLucideIcon, R as React, al as useTheme, j as jsxRuntimeExports, B as Button, J as cn, d as useToast, u as useQuery, r as reactExports, ae as lookup, q as queryClient, f as useMutation, N as motion, p as User, O as AnimatePresence, X, L as LoaderCircle, am as ChevronRight, x as Send, h as MessageSquare, af as Phone, an as MicOff, ao as Mic, ap as VolumeX, ak as Volume2, aq as PhoneOff, P as Package, ah as Database } from "./index-ARQpEXVI.js";
...
import { W as Wallet } from "./wallet-C5MeIeST.js";
import { H as History } from "./history-CLF6rWrk.js";
import { C as CreditCard } from "./credit-card-BGqI44c0.js";
import { Z as Zap, P as Paperclip } from "./zap-BcO9PPcT.js";
import { C as CircleCheck } from "./circle-check-DVO_qO30.js";
import { M as MessageCircle } from "./message-circle-FaAQw6OT.js";
import { F as FileText } from "./file-text-eZZ4PCcz.js";
import { C as Copy } from "./copy-C6qIi8RU.js";
import { L as Lock } from "./lock-BkHBkV80.js";
...
function MiniAppShop() {
  ...
  const [isCallMuted, setIsCallMuted] = reactExports.useState(false);
  const [isSpeakerMuted, setIsSpeakerMuted] = reactExports.useState(false);
  const [showAutoCallPrompt, setShowAutoCallPrompt] = reactExports.useState(false);
  const [callDuration, setCallDuration] = reactExports.useState(0);
  const callSocketRef = reactExports.useRef(null);
  ...
  const durationTimerRef = reactExports.useRef(null);
  const cleanUpCall = () => {
    setCallState("idle");
  ...
  const answerIncomingCall = async () => {
    ...
    callSocketRef.current.on("ice-candidate", async (iceData) => {
      try {
        if (pc.remoteDescription) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tg-mini-app min-h-screen text-neutral-900 dark:text-foreground font-sans selection:bg-purple-200 pb-32", style: { background: "inherit" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-24 right-4 z-50", children: [
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-4 space-y-4 scrollbar-hide min-h-0", children: [
              chatMode === "ai" ? chatHistory.map((msg, i) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex flex-col w-full ${!isAdmin ? "items-end" : "items-start"} animate-in slide-in-from-bottom-2 duration-300`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-[85%] p-3 rounded-2xl text-[11px] leading-relaxed ${!isAdmin ? "bg-primary text-white rounded-tr-none shadow-lg" : "bg-white/5 text-white/90 border border-white/10 rounded-tl-none"}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isDepositModalOpen, onOpenChange: (open) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-2xl font-black tracking-tighter uppercase italic", children: activeDeposit ? activeDeposit.method === "stripe" ? "Stripe Checkout" : "Verify Crypto Payment" : "Top Up Balance" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-xs font-bold uppercase tracking-widest text-neutral-400 dark:text-neutral-500 mt-1", children: activeDeposit ? activeDeposit.method === "stripe" ? "Complete Card Payment" : "Submit transaction details" : "Select amount and method" }),
        ...
        ] }) : activeDeposit.method === "stripe" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4 space-y-6 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-3xl bg-purple-50 dark:bg-purple-950/50 flex items-center justify-center text-[#635BFF] shadow-inner", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 24 24", className: "w-8 h-8 fill-current", xmlns: "http://www.w3.org/2000/svg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Stripe" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M13.976 9.15c-2.172-.806-3.356-1.426-3.356-2.409 0-.831.683-1.305 1.901-1.305 2.227 0 4.515.858 6.09 1.631l.89-5.494C18.252.975 15.697 0 12.165 0 9.667 0 7.589.654 6.104 1.872 4.56 3.147 3.757 4.992 3.757 7.218c0 4.039 2.467 5.76 6.476 7.219 2.585.92 3.445 1.574 3.445 2.583 0 .98-.84 1.545-2.354 1.545-1.875 0-4.965-.921-6.99-2.109l-.9 5.555C5.175 22.99 8.385 24 11.714 24c2.641 0 4.843-.624 6.328-1.813 1.664-1.305 2.525-3.236 2.525-5.732 0-4.128-2.524-5.851-6.594-7.305h.003z" })
          ] }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-black uppercase tracking-wider text-neutral-400", children: "Total Charged" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-2xl font-black text-neutral-900 dark:text-white", children: [
              "$",
              activeDeposit.amount.toFixed(2),
              " USD"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-purple-950/10 border border-purple-500/20 p-4 rounded-2xl text-[10px] uppercase font-black tracking-widest text-purple-400 text-center leading-relaxed max-w-[280px] mx-auto", children: "⚠️ If checkout didn't open automatically, click button below to pay." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "flex gap-3 pt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "ghost",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Pay with Card" })
              }
            )
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isSupportMenuOpen && !isChatOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "flex items-center gap-2.5 group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-black uppercase text-white bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/5 shadow-md whitespace-nowrap", children: "Live Agent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.button,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "flex items-center gap-2.5 group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-black uppercase text-white bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/5 shadow-md whitespace-nowrap", children: "Voice Call" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.button,
                {
                  whileHover: { scale: 1.1 },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: itemVariants, className: "flex items-center gap-2.5 group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-black uppercase text-white bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/5 shadow-md whitespace-nowrap", children: "WhatsApp Support" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.button,
                {
                  whileHover: { scale: 1.1 },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("audio", { ref: remoteAudioRef, style: { display: "none" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatePresence, { children: [
      callState !== "idle" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center gap-2 mt-12", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black uppercase tracking-[0.2em] text-blue-500 bg-blue-500/10 px-4 py-1.5 rounded-full border border-blue-500/20 shadow-lg shadow-blue-500/5", children: "Support Voice Call" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-4 tracking-wider", children: "Support Agent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-semibold text-white/50 lowercase tracking-widest mt-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-64 h-64 flex items-center justify-center", children: [
              callState !== "ended" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-32 h-32 rounded-full bg-gradient-to-tr from-blue-700 to-purple-600 border border-blue-400/20 shadow-2xl flex items-center justify-center relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-12 h-12 text-white/90 animate-pulse" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center gap-8 w-full max-w-xs mb-10", children: callState === "ringing" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-around w-full gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.button,
                {
                  whileHover: { scale: 1.05 },
            ...
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-around w-full gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.button,
                {
                  whileHover: { scale: 1.05 },
                  ...
                  className: `w-14 h-14 rounded-full flex items-center justify-center border transition-all duration-300 ${isCallMuted ? "bg-red-500/25 border-red-500/40 text-red-500" : "bg-white/5 border-white/10 text-white/80 hover:bg-white/10"}`,
                  children: isCallMuted ? /* @__PURE__ */ jsxRuntimeExports.jsx(MicOff, { className: "w-6 h-6" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { className: "w-6 h-6" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.button,
                {
                  ...
                  disabled: callState === "ended",
                  className: `w-14 h-14 rounded-full flex items-center justify-center border transition-all duration-300 ${isSpeakerMuted ? "bg-red-500/25 border-red-500/40 text-red-500" : "bg-white/5 border-white/10 text-white/80 hover:bg-white/10"}`,
                  children: isSpeakerMuted ? /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeX, { className: "w-6 h-6" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { className: "w-6 h-6" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.button,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(PhoneOff, { className: "w-8 h-8" })
                }
              )
            ] }) })
          ]
      ...
      showAutoCallPrompt && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0 },
          animate: { opacity: 1 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center gap-2 mt-12", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black uppercase tracking-[0.2em] text-purple-500 bg-purple-500/10 px-4 py-1.5 rounded-full border border-purple-500/20 shadow-lg shadow-purple-500/5", children: "Support Calling Line" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black text-white mt-4 tracking-wider", children: "Voice Call Center" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-white/50 lowercase tracking-widest mt-1", children: "Connecting you to an agent..." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-64 h-64 flex items-center justify-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-32 h-32 rounded-full bg-gradient-to-tr from-purple-700 to-indigo-600 border border-purple-400/20 shadow-2xl flex items-center justify-center relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-12 h-12 text-white/90 animate-bounce" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center gap-8 w-full max-w-xs mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-around w-full gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.button,
                {
                  whileHover: { scale: 1.05 },
