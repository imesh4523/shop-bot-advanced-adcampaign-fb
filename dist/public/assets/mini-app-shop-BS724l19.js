import { c as createLucideIcon, R as React, ai as useTheme, j as jsxRuntimeExports, B as Button, H as cn, d as useToast, u as useQuery, r as reactExports, ac as lookup, q as queryClient, e as useMutation, o as User, X, L as LoaderCircle, aj as ChevronRight, v as Send, P as Package, ae as Database, t as ShieldCheck } from "./index-Bn3jhzv0.js";
...
import { m as motion, A as AnimatePresence } from "./proxy-jGRxHbf-.js";
import { W as Wallet } from "./wallet-DIAFjQBp.js";
import { H as History } from "./history-BW31yEtB.js";
import { C as CreditCard } from "./credit-card-CfSoAFup.js";
import { Z as Zap } from "./zap-C1WXmnZz.js";
import { C as CircleCheck } from "./circle-check-DQlzof54.js";
import { M as MessageCircle } from "./message-circle-DJZ_HslJ.js";
import { C as Copy } from "./copy-YLxjOgw_.js";
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 overflow-x-auto pb-2 px-1 scrollbar-hide no-scrollbar", children: [
          ...
          { id: "chatgpt", label: "ChatGPT", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/openai.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) },
          { id: "claude", label: "Claude", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/claude.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) },
          { id: "gemini", label: "Gemini", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/gemini.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) },
          { id: "cursor", label: "Cursor", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/cursor.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) },
          { id: "capcut", label: "CapCut", icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/capcut.svg", className: "w-4 h-4 object-contain group-hover:brightness-0 group-hover:invert transition-all" }) }
