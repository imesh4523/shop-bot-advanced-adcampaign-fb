import { c as createLucideIcon, R as React, ai as useTheme, j as jsxRuntimeExports, B as Button, I as cn, e as useToast, u as useQuery, r as reactExports, ac as lookup, q as queryClient, f as useMutation, p as User, X, L as LoaderCircle, aj as ChevronRight, w as Send, P as Package, ae as Database, v as ShieldCheck } from "./index-DhpizRmA.js";
...
import { m as motion, A as AnimatePresence } from "./proxy-CAhRciLZ.js";
import { W as Wallet } from "./wallet-DnAobyQy.js";
import { H as History } from "./history-DPQfOXg1.js";
import { C as CreditCard } from "./credit-card-DL4e74cm.js";
import { Z as Zap, P as Paperclip } from "./zap-CxixQB7m.js";
import { C as CircleCheck } from "./circle-check-CkFDQ2Jn.js";
import { M as MessageCircle } from "./message-circle-DJM6-22p.js";
import { F as FileText } from "./file-text-BZuoe4Uv.js";
import { C as Copy } from "./copy-DthNocMl.js";
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 overflow-x-auto pb-2 px-1 scrollbar-hide no-scrollbar", children: [
          ...
          { id: "chatgpt", label: "ChatGPT", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiOpenai, { className: "w-4 h-4", style: { color: "#10a37f" } }) },
          { id: "claude", label: "Claude", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiClaude, { className: "w-4 h-4", style: { color: "#D4A574" } }) },
          { id: "gemini", label: "Gemini", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiGooglegemini, { className: "w-4 h-4", style: { color: "#4285F4" } }) },
          { id: "cursor", label: "Cursor", icon: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 24 24", className: "w-4 h-4", fill: "none", children: [
          ...
          { id: "capcut", label: "CapCut", icon: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 24 24", className: "w-4 h-4", children: [
      ...
      isGuest2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card border border-purple-100/50 rounded-[3rem] p-8 space-y-6 relative overflow-hidden bg-white/80 backdrop-blur-xl", children: [
        ...
        !otpSent ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          googleEnabled && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 pt-4 border-t border-neutral-100", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "google-signin-btn-drawer", className: "w-full flex justify-center scale-95" })
          ] })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  ...
                  msg.attachmentUrl && msg.attachmentType === "pdf" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate text-[9px] hover:underline", children: "View PDF Document" })
                      ]
                    }
                  ),
                  (!msg.attachmentUrl || msg.message !== "📷 Photo Attachment" && msg.message !== "📄 PDF Attachment") && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1 break-all", children: msg.message }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isLoginDialogOpen, onOpenChange: (open) => {
        ...
        !otpSent ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4 space-y-6", children: [
          ...
          googleEnabled && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 pt-4 border-t border-neutral-100 dark:border-white/5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "google-signin-btn-dialog", className: "w-full flex justify-center scale-95" })
          ] })
