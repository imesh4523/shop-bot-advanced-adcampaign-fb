import { d as useToast, e as useQueryClient, r as reactExports, u as useQuery, f as useMutation, ac as lookup, j as jsxRuntimeExports, h as MessageSquare, L as LoaderCircle, B as Button, ag as Settings, X, x as Send, i as apiRequest } from "./index-OSNgoIaX.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent, d as CardDescription } from "./card-CtEaxI2G.js";
...
import { Z as Zap, P as Paperclip } from "./zap-Dx3oOeFs.js";
import { C as Copy } from "./copy-DsEl3j8a.js";
...
function SupportChatPage() {
  ...
  let parsedQuickReplies = DEFAULT_QUICK_REPLIES;
  if (quickRepliesSetting?.value) {
    try {
      const parsed = JSON.parse(quickRepliesSetting.value);
      if (Array.isArray(parsed)) {
        if (parsed.every((p) => typeof p === "string")) {
          parsedQuickReplies = parsed.map((t) => ({ text: t, copyable: false }));
        } else if (parsed.every((p) => typeof p === "object" && "text" in p)) {
  ...
  const handleDeleteThread = async (telegramId) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 animate-in fade-in duration-700", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "lg:col-span-1 glass-card border-0 flex flex-col h-[650px] overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0 flex-1 overflow-y-auto min-h-0", children: isChatsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full gap-3 text-white/40", children: [
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `w-full relative group flex items-start border-l-4 transition-all duration-300 ${isSelected ? "bg-purple-950/20 border-purple-500" : "hover:bg-white/[0.02] border-transparent"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl overflow-hidden bg-neutral-900 border border-white/10 shrink-0", children: chat.avatarUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: chat.avatarUrl, alt: "avatar", className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-full h-full bg-gradient-to-tr ${getAvatarBg(chat)} flex items-center justify-center font-bold text-white shadow-md text-sm`, children: getAvatarInitials(chat) }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 pr-6", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/50 truncate leading-relaxed flex-1", children: chat.lastMessage }),
                          chat.pendingCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shrink-0 flex items-center justify-center min-w-[18px] h-[18px] px-1 text-[9px] font-black text-white bg-red-500 rounded-full shadow-md animate-pulse", children: chat.pendingCount })
                        ] })
                      ] })
                    ]
                  }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "lg:col-span-2 glass-card border-0 flex flex-col h-[650px] overflow-hidden", children: selectedChatId && activeChat ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "p-5 border-b border-white/5 shrink-0 flex flex-row items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl overflow-hidden bg-neutral-900 border border-white/10 shrink-0", children: activeChat.avatarUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: activeChat.avatarUrl, alt: "avatar", className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-full h-full bg-gradient-to-tr ${getAvatarBg(activeChat)} flex items-center justify-center font-bold text-white text-sm shadow`, children: getAvatarInitials(activeChat) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    msg.attachmentUrl && (msg.attachmentType === "pdf" || msg.attachmentType === "document") && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "a",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate text-xs hover:underline", children: msg.attachmentType === "pdf" ? "View PDF Document" : "View Document File" })
                        ]
                      }
                    ),
                    (!msg.attachmentUrl || msg.message !== "📷 Photo Attachment" && msg.message !== "📄 PDF Attachment" && msg.message !== "📄 Attachment") && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: msg.message })
                  ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-t border-white/5 bg-[#0f0a1a]/50 shrink-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 overflow-x-auto scrollbar-none pb-1 select-none", children: parsedQuickReplies.map((reply, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                reply.text,
                reply.copyable && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { title: "Shows copy button for user", className: "text-purple-400 group-hover:text-white/70", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "w-2.5 h-2.5" }) })
              ]
            },
            idx
          )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isEditingTemplates, onOpenChange: setIsEditingTemplates, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "glass-panel border-white/10 bg-black/90 text-white max-w-lg rounded-2xl p-6 max-h-[calc(100dvh-4rem)] overflow-y-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 my-4 max-h-[360px] overflow-y-auto pr-1", children: [
        editingList.map((template, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-start p-3 bg-white/[0.02] rounded-xl border border-white/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider transition-all ${template.copyable ? "bg-purple-500/20 text-purple-300 border border-purple-500/30" : "bg-white/5 text-white/30 border border-white/10 hover:border-white/20"}`,
                children: [
