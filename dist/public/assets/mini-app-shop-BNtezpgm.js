import { c as createLucideIcon, R as React, ai as useTheme, j as jsxRuntimeExports, B as Button, H as cn, d as useToast, r as reactExports, u as useQuery, ac as lookup, q as queryClient, e as useMutation, o as User, X, L as LoaderCircle, aj as ChevronRight, v as Send, P as Package, ae as Database, t as ShieldCheck } from "./index-DPyAPMUc.js";
...
import { m as motion, A as AnimatePresence } from "./proxy-DtP8tN1b.js";
import { W as Wallet } from "./wallet-B3xad5ap.js";
import { H as History } from "./history-BofYunWu.js";
import { C as CreditCard } from "./credit-card-BWcn6IdK.js";
import { Z as Zap } from "./zap-BYwwOkQ2.js";
import { C as CircleCheck } from "./circle-check-DCcnIHBL.js";
import { M as MessageCircle } from "./message-circle-BAx6pavY.js";
import { C as Copy } from "./copy-DRcqFQn0.js";
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-4 space-y-4 scrollbar-hide min-h-[300px]", children: [
              chatMode === "ai" ? chatHistory.map((msg, i) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex flex-col w-full ${!isAdmin ? "items-end" : "items-start"} animate-in slide-in-from-bottom-2 duration-300`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-[85%] p-3 rounded-2xl text-[11px] leading-relaxed ${!isAdmin ? "bg-primary text-white rounded-tr-none shadow-lg" : "bg-gradient-to-br from-purple-600 to-indigo-700 text-white rounded-tl-none border border-white/5 shadow-md"}`, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[7px] text-white/30 text-right mt-1 font-semibold uppercase", children: msg.createdAt ? format(new Date(msg.createdAt), "hh:mm a") : "" })
                ] }) }, msg.id || i);
              }) }),
