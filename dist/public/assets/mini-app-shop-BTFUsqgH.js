import { b as createLucideIcon, R as React, ai as useTheme, j as jsxRuntimeExports, B as Button, J as cn, e as useToast, u as useQuery, r as reactExports, ac as lookup, q as queryClient, f as useMutation, p as User, X, L as LoaderCircle, aj as ChevronRight, x as Send, P as Package, ae as Database, w as ShieldCheck } from "./index-vEK6vUxS.js";
...
import { m as motion, A as AnimatePresence } from "./proxy-BU0fUCno.js";
import { W as Wallet } from "./wallet-D_juFM95.js";
import { H as History } from "./history-CPmYkbtm.js";
import { C as CreditCard } from "./credit-card-BPD2fMJO.js";
import { Z as Zap, P as Paperclip } from "./zap-DKwZqgyw.js";
import { C as CircleCheck } from "./circle-check-BqZvbrKu.js";
import { M as MessageCircle } from "./message-circle-DTD5Ps4d.js";
import { F as FileText } from "./file-text-ByYQL-GP.js";
import { C as Copy } from "./copy-C_LrOf_8.js";
        ...
        !activeDeposit ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4 space-y-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-50/50 dark:bg-white/5 p-5 rounded-3xl border border-purple-100 dark:border-white/10 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-xs", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-black text-neutral-900 dark:text-white", children: (() => {
                const rateLkr = liveLkrRate;
                if (activeDeposit.method === "binance" && selectedDepositCurrency === "LKR") {
                  const usdt = activeDeposit.amount / rateLkr;
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-neutral-400 text-[10px] mr-2", children: [
                      "Rs. ",
            ...
            activeDeposit.method === "binance" && selectedDepositCurrency === "LKR" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-[10px] text-neutral-400", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "uppercase tracking-widest font-bold", children: "Rate:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                "1 USDT ≈ Rs. ",
                liveLkrRate.toFixed(2),
                " LKR"
              ] }),
              p2pRateData && !p2pRateData.cached && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-[9px] text-teal-400 font-bold uppercase", children: "● Live" })
            ] }),
