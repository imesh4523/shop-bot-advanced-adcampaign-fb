import { d as useToast, r as reactExports, u as useQuery, f as useMutation, j as jsxRuntimeExports, B as Button, L as LoaderCircle, q as queryClient, i as apiRequest } from "./index-AVTcAVZ5.js";
import { a as api, b as buildUrl } from "./routes-CuIIW9wP.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-BvHNc7VY.js";
import { I as Input } from "./input-DiCWhiOJ.js";
import { D as Dialog, a as DialogTrigger, b as DialogContent, c as DialogHeader, d as DialogTitle, f as DialogFooter } from "./dialog-DC565KD2.js";
...
import { u as useForm, F as Form, a as FormField, b as FormItem, c as FormLabel, d as FormControl, e as FormMessage, t } from "./form-CvrXuiDH.js";
import { a as insertCredentialSchema } from "./schema-DTjBPKAW.js";
import { u as useProducts } from "./use-products-BdEu8sgT.js";
import { P as Plus } from "./plus-CcVI4HuK.js";
import { K as Key } from "./key-DEdpIfA9.js";
import { S as Search } from "./search-BP46ga0N.js";
import { T as Trash2 } from "./trash-2-DyBOS6eY.js";
import { S as Server } from "./server-DvQrRuQn.js";
import { P as Pen } from "./pen-2TmILN1_.js";
import "./index-DwfS90rP.js";
import "./index-IXOTxK3N.js";
import "./index-4lV8XwQG.js";
import "./label-Bpui1eSE.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 animate-in", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 items-center", children: [
      ...
      selectedIds.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          children: [
            bulkDeleteMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "mr-2 h-4 w-4" }),
            "Delete Selected (",
            selectedIds.length,
            ")"
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass-card border-0 rounded-2xl overflow-hidden shadow-2xl bg-white/[0.01] backdrop-blur-3xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "border-white/5 hover:bg-transparent", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-[50px] pl-6 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "checkbox",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { colSpan: 5, className: "text-center py-12 text-white/20 text-xs", children: "Loading..." }) }) : filteredCredentials?.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { colSpan: 5, className: "h-48 text-center text-white/20 font-black text-sm uppercase tracking-tighter", children: "No stock found in inventory." }) }) : filteredCredentials?.map((cred) => {
        const product = products?.find((p) => p.id === cred.productId);
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "border-white/5 hover:bg-white/[0.03] transition-all duration-300 group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "pl-6 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "checkbox",
              className: "rounded border-white/10 bg-black/40 text-purple-600 focus:ring-purple-500 cursor-pointer",
