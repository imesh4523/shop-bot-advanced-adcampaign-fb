import { t as createLucideIcon, R as React, ah as useTheme, j as jsxRuntimeExports, B as Button, I as cn, b as useToast, u as useQuery, r as reactExports, ac as lookup, q as queryClient, d as useMutation, n as User, X, L as LoaderCircle, ai as ChevronRight, w as Send, P as Package, v as ShieldCheck, ae as Database } from "./index-Bq65OpBd.js";
...
import { m as motion, A as AnimatePresence } from "./proxy-E-XN7d4m.js";
import { W as Wallet } from "./wallet-B0nptYsQ.js";
import { H as History } from "./history-DNY7bCyb.js";
import { C as CreditCard } from "./credit-card-CsywgpOl.js";
import { Z as Zap, P as Paperclip } from "./zap-DkoGnMl-.js";
import { C as CircleCheck } from "./circle-check-IOIAlNVw.js";
import { M as MessageCircle } from "./message-circle-CKngD6ie.js";
import { F as FileText } from "./file-text-V1Rf3qDr.js";
import { C as Copy } from "./copy-Cmtu4RbE.js";
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-4 space-y-4 scrollbar-hide min-h-[300px]", children: [
              chatMode === "ai" ? chatHistory.map((msg, i) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex flex-col w-full ${!isAdmin ? "items-end" : "items-start"} animate-in slide-in-from-bottom-2 duration-300`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-[85%] p-3 rounded-2xl text-[11px] leading-relaxed ${!isAdmin ? "bg-primary text-white rounded-tr-none shadow-lg" : "bg-gradient-to-br from-purple-600 to-indigo-700 text-white rounded-tl-none border border-white/5 shadow-md"}`, children: [
                  ...
                  (!msg.attachmentUrl || displayMessage !== "📷 Photo Attachment" && displayMessage !== "📄 PDF Attachment") && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1 break-all whitespace-pre-wrap", children: displayMessage }),
              ...
              chatMode === "human" && liveMessages.length > 0 && liveMessages[liveMessages.length - 1].sender === "user" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center p-5 bg-purple-950/10 border border-purple-500/20 rounded-2xl gap-3 animate-pulse mt-4", children: [
