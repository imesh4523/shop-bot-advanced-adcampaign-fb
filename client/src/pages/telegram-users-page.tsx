                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-white/60">
                      {user.telegramId.startsWith("email:") ? (
                        <span>Email: {user.telegramId.replace("email:", "")}</span>
                      ) : user.telegramId.startsWith("web_guest_") ? (
                        <span>Guest ID: {user.telegramId.substring(10, 18)}</span>
                      ) : (
                        <span>Telegram ID: {user.telegramId} {user.username && `(@${user.username})`}</span>
                      )}
                    </p>
        ...
        <DialogContent className="glass-card border-white/20">
          <DialogHeader>
            <DialogTitle className="text-white">
              Edit Balance for {editingId !== null && (() => {
